/* empty css                                    */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, b as createAstro, d as renderComponent, a as addAttribute } from '../chunks/astro/server_Ciz6EALz.mjs';
import 'kleur/colors';
import { a as getBlogs, $ as $$BaseLayout } from '../chunks/microcms_BhAfFWBj.mjs';
import 'clsx';
/* empty css                                 */
...
コミュニケーションツールはzoom、slackの使用が長いですが、
					ご要望に応じて柔軟に対応可能です。
</p> <p class="pb-2" data-astro-cid-j7pv25f6>作って終わりではなく、定期的に効果検証を行って課題改善に尽くします。</p> </div> </div> <div class="tag flex gap-4 flex-wrap justify-between" data-astro-cid-j7pv25f6> <p class="capitalize bg-white px-4 py-1 md:px-8 md:py-2  rounded-full font-semibold" data-astro-cid-j7pv25f6>figma</p> <p class="capitalize bg-white px-4 py-1 md:px-8 md:py-2 rounded-full font-semibold" data-astro-cid-j7pv25f6>studio</p> <p class="capitalize bg-white px-4 py-1 md:px-8 md:py-2 rounded-full font-semibold" data-astro-cid-j7pv25f6>astro</p> <p class=" bg-white px-4 py-1 md:px-8 md:py-2 rounded-full font-semibold" data-astro-cid-j7pv25f6>Tailwind.css</p> <p class=" bg-white px-4 py-1 md:px-8 md:py-2 rounded-full font-semibold" data-astro-cid-j7pv25f6>React.js</p> <p class="capitalize bg-white px-4 py-1 md:px-8 md:py-2 rounded-full font-semibold" data-astro-cid-j7pv25f6>docker</p> <p class="capitalize bg-white px-4 py-1 md:px-8 md:py-2 rounded-full font-semibold" data-astro-cid-j7pv25f6>wordpress</p> </div> </section> <section class=" text-white bg-black py-20 md:py-40" id="profile" data-astro-cid-j7pv25f6> <div class="max-w-screen-lg mx-auto w-11/12" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "SectionHeading", $$SectionHeading, { "title": "Profile", "subTitle": "\u7D4C\u6B74", "data-astro-cid-j7pv25f6": true })} <div class=" leading-loose" data-astro-cid-j7pv25f6> <p class="pb-6" data-astro-cid-j7pv25f6>4月11日生まれ / O型 /埼玉県出身/宮城県在住</p> <p class="pb-6" data-astro-cid-j7pv25f6>Webデザインの専門学校を卒業後、地方暮らしに憧れを抱き、
